<div>
    ...
    <form wire:submit.prevent="store" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" wire:model="image" name="image" id="image" class="form form-control">

                    </div>
                    <div class="mb-3">
                        <label for="decription" class="form-label">Descrivi il tuo articolo</label>
                        <textarea name="decription" wire:model="description"  id="decription" placeholder="Inserisci una descrizione" class="form form-control">{{old('decription')}}</textarea>
                    </div>
