...
<div class="card bg-body-panna my-4">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <span class="text-body-tertiary">Ultima modifica: {{ $announcement->updated_at->format('d/m/Y') }}</span>
        </div>
        <div class="card-body d-flex justify-content-between">
            ...
            <div class="btn-container">
                <button class="btn btn-warning text-white bottom" wire:click="editAnnouncementUser({{ $announcement->id }})">Modifica<i class="bi bi-pencil-fill"></i></button>
                <button class="btn btn-danger" wire:click="deleteAnnouncement({{ $announcement->id }})"><i class="bi bi-trash-fill">Elimina</i></button>
            </div>
        </div>
    </div>
@endforeach
